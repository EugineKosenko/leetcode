#+title: =Leetcode=, задача =2016=

* Головний файл

#+begin_src rust :noweb yes :tangle src/bin/task2016.rs
  <<task2016:Декларації>>
...
#+begin_src rust :noweb-ref task2016:Декларації
  use std::env;
#+end_src

#+begin_src rust :noweb-ref task2016:Отримання-даних
...
#+begin_src rust :noweb-ref task2016:Дії
  nums.into_iter()
...
#+begin_src rust :noweb yes :noweb-ref task2016:Визначення
#[cfg(test)]
mod tests {
    use super::*;

    <<task2016:tests:Визначення>>
}
#+end_src 

** Тести з опису задачі

#+begin_src rust :noweb-ref task2016:tests:Визначення
  #[test]
  fn test_example1() {
